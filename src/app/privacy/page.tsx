...
export default function PrivacyPolicyPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-navy-darkest to-navy-dark">
      <Header />
      ...
      <main className="pt-20">
        ...
        <section className="py-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold text-gold-light mb-6">
              Privacy Policy
            </h1>
            <p className="text-xl text-gold-lightest">
              Your privacy is important to us. This policy explains how we collect, use, and protect your information.
            </p>
            <p className="text-sm text-gold-lightest opacity-80 mt-4">
        ...
        <section className="py-16 px-4">
          <div className="max-w-4xl mx-auto">
            <div className="bg-navy-medium bg-opacity-50 backdrop-blur-sm rounded-2xl p-8 space-y-8">
              ...
              <div>
                ...
                <div className="space-y-4 text-gold-lightest">
                  <div>
                    <h3 className="text-lg font-semibold text-gold-light mb-2">Personal Information</h3>
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gold-light mb-2">Automatically Collected Information</h3>
              ...
              <div>
                ...
                <div className="text-gold-lightest space-y-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gold-light mb-2">Service Providers</h3>
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gold-light mb-2">Legal Requirements</h3>
              ...
              <div>
                ...
                <div className="text-gold-lightest space-y-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gold-light mb-2">Types of Cookies</h3>
