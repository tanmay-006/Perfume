    ...
    <div className="min-h-screen bg-[var(--background)]">
      ...
      <section className="pt-20 pb-16 px-4 bg-gradient-to-r from-[var(--navy-darkest)] to-[var(--navy-dark)]">
        <div className="max-w-4xl mx-auto text-center pt-8">
          <h1 className="text-4xl md:text-5xl font-bold text-white/90 mb-4">Shipping & Returns</h1>
          <p className="text-xl text-white/70">Fast delivery and easy returns</p>
          <p className="text-white/60 mt-2">Your satisfaction is our priority</p>
        </div>
      </section>
